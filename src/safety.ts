...
export const ACTION_TIERS: Record<string, SafetyTier> = {
  ...
  // Accounts — elevated: sudo/privilege escalation vectors
  user_create: SafetyTier.ConfirmWithReason,
  user_update: SafetyTier.ConfirmWithReason,
  user_set_password: SafetyTier.Confirm,
  user_delete: SafetyTier.Confirm,
  group_create: SafetyTier.Confirm,
  group_update: SafetyTier.ConfirmWithReason,
  ...
  // Service configs — ssh elevated: root login/password auth vectors
  ssh_config_update: SafetyTier.ConfirmWithReason,
  ...
  // Audit & privileges — elevated: web_shell/wildcard API access vectors
  audit_config_update: SafetyTier.Confirm,
  privilege_create: SafetyTier.ConfirmWithReason,
  privilege_update: SafetyTier.ConfirmWithReason,
  ...
  pool_update: SafetyTier.Confirm,
  ...
  dataset_unlock: SafetyTier.Confirm,
  ...
  rsync_task_update: SafetyTier.Confirm,
  rsync_task_delete: SafetyTier.Confirm,
  rsync_task_run: SafetyTier.Confirm,
  initshutdown_list: SafetyTier.Open,
  initshutdown_delete: SafetyTier.Confirm,
  ...
  smb_share_create: SafetyTier.Confirm,
  smb_share_update: SafetyTier.Confirm,
  smb_config: SafetyTier.Open,
  nfs_share_list: SafetyTier.Open,
  nfs_share_get: SafetyTier.Open,
  nfs_share_create: SafetyTier.Confirm,
  nfs_share_update: SafetyTier.Confirm,
  ...
  // iSCSI create/update gated like SMB/NFS share creates — they provision
  // block storage (an extent points at a real /mnt file).
  iscsi_target_create: SafetyTier.Confirm,
  iscsi_target_update: SafetyTier.Confirm,
  iscsi_extent_list: SafetyTier.Open,
  iscsi_extent_create: SafetyTier.Confirm,
  iscsi_extent_update: SafetyTier.Confirm,
  iscsi_portal_list: SafetyTier.Open,
  iscsi_portal_create: SafetyTier.Confirm,
  iscsi_portal_update: SafetyTier.Confirm,
  iscsi_initiator_list: SafetyTier.Open,
  iscsi_initiator_create: SafetyTier.Confirm,
  iscsi_targetextent_list: SafetyTier.Open,
  iscsi_targetextent_create: SafetyTier.Confirm,
  ...
  replication_run: SafetyTier.Confirm,
  replication_restore: SafetyTier.Open,
  cloudsync_list: SafetyTier.Open,
  cloudsync_get: SafetyTier.Open,
  cloudsync_update: SafetyTier.Confirm,
  cloudsync_run: SafetyTier.Confirm,
  ...
  cloudsync_credentials_delete: SafetyTier.Confirm,
  ...
  cloud_backup_delete: SafetyTier.Confirm,
  cloud_backup_run: SafetyTier.Confirm,
  cloud_backup_abort: SafetyTier.Open,
  cloud_backup_snapshots: SafetyTier.Open,
  cronjob_list: SafetyTier.Open,
  cronjob_delete: SafetyTier.Confirm,
  cronjob_run: SafetyTier.Confirm,
